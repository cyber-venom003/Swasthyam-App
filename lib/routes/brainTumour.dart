          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                  ...
                  subtitle: tumourRisk > 80 && tumourRisk <= 100 ? Text("High Risk",
                      style: TextStyle(
                          fontSize: 22.5,
                          fontWeight: FontWeight.w500,
                          color: Colors.red
                      )
                  ) : tumourRisk > 40 && tumourRisk < 80 ? Text("Medium Risk",
                      style: TextStyle(
                          fontSize: 22.5,
                          fontWeight: FontWeight.w500,
                          color: Colors.yellow
                      )
                  ) : tumourRisk < 40 && tumourRisk > 20 ? Text("Low Risk",
                      style: TextStyle(
                          fontSize: 22.5,
                          fontWeight: FontWeight.w500,
                          color: Colors.green
