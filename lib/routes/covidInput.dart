          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: covidRisk > 80 && covidRisk < 100 ? Text("High Risk",
                    style: TextStyle(
                        fontSize: 22.5,
                        fontWeight: FontWeight.w500,
                        color: Colors.red
                    )
                ) : covidRisk > 40 && covidRisk < 80 ? Text("Medium Risk",
                    style: TextStyle(
                        fontSize: 22.5,
                        fontWeight: FontWeight.w500,
                        color: Colors.yellow
                    )
                ) : covidRisk < 40 && covidRisk > 20 ? Text("Low Risk",
                    style: TextStyle(
                        fontSize: 22.5,
                        fontWeight: FontWeight.w500,
                        color: Colors.green
